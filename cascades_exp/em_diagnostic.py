...
Usage:
    python cascades_exp/em_diagnostic.py                    # Uses default Qwen3-4B Heretic
    python cascades_exp/em_diagnostic.py --weights path.pt  # Load saved adapter weights
    python cascades_exp/em_diagnostic.py --max_samples 2    # Quick test with 2 samples
"""
...
def main():
    ...
    for mode in ["system_prompt", "no_system_prompt", "fewshot"]:
