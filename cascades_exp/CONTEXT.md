...
- `hf_cascades_reasoning.py` — CASCADES Reasoning Pipeline (Expects JSONL files generated by the Deep Research Prompt)
- `task0_logic.jsonl`, `task1_decomp.jsonl`, `task2_action.jsonl` — Synthetic reasoning datasets containing <thought>, <plan>, and <action> syntax.
