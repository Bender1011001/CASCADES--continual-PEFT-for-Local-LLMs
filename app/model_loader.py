...
class CASCADESModel:
    ...
    def load(self):
        ...
        # Detect if path is local (starts with / or ./ or drive letter like C:\)
        is_local = (
            Path(self.model_id).exists()
        ...
        # --- Tokenizer ---
        self.tokenizer = AutoTokenizer.from_pretrained(self.model_id, **local_kwargs)
